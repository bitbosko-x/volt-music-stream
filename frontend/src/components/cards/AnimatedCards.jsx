...
/* ─── ALBUM CARD ─────────────────────────────────────────── */
export function AnimatedAlbumCard({ item, delay = 0, onPlay, isPlaying, wrapperClass = "", fluid = false }) {
    ...
    return (
        <div
            ...
            style={{
                width: fluid ? "100%" : 170, flexShrink: 0, cursor: "pointer",
                opacity: visible ? 1 : 0,
        ...
        >
            {/* Square art — uses padding-bottom trick for responsive aspect ratio */}
            <div style={{
                width: "100%", paddingBottom: "100%", borderRadius: 12, overflow: "hidden",
                position: "relative",
            ...
            <div style={{ padding: "10px 2px 0" }}>
                ...
                <div style={{ fontSize: 12, color: "#666", marginTop: 3, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{item.artist || item.subtitle}</div>
            </div>
        </div>
    );
}
